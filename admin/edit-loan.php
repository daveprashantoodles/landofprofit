...
$query = mysqli_query($con, "SELECT * FROM `loan` WHERE `id`='".$id."' ");
...
<aside class="right-side">
	<section class="content-header">
		<h1>Loan<!--<small>Preview</small>--></h1>
	</section>
<!-- Main content -->
	<section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Loan</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="loanform" id="loanform"  method="post" action="loan-process.php" autocomplete="off" enctype="multipart/form-data">
                 
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="loan_title" class="col-lg-4 control-label">
									Loan Title<span class="mandatory">*</span>
								</label>
								<div class="col-lg-8">
									<input type="text" class="form-control isRequired" id="loan_title" name="loan_title" placeholder="Enter Loan Title" title="Please enter Loan Title" value="<?php echo isset($data['loan_title'])?$data['loan_title']:"";?>" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="titleSlug" class="col-sm-3 control-label">
									Loan Slug <span class="mandatory">*</span>
								</label>
								<div class="col-sm-9">
									<input type="text" class="form-control isRequired" id="titleSlug" name="titleSlug" placeholder="Loan slug" title="Please enter Loan Slug" value="<?php echo isset($data['titleSlug'])?$data['titleSlug']:"";?>"/>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="col-lg-8">
									<div class="fileinput fileinput-new fileinputCat" data-provides="fileinput">
										...
										<div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">		
											...
											?>
												<img src="../<?php echo $loanImg."/".$data['image']; ?>"/>
											<?php 
												}
												else{
											?>
