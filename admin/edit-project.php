...
$query = mysqli_query($con, "SELECT * FROM `project` WHERE `id`='".$id."' ");
    ...
    <div class="">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit project</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="projectform" id="projectform"  method="post" action="project-process.php" autocomplete="off" enctype="multipart/form-data">
				  
					
                 <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                     <label for="name" class="col-lg-4 control-label">project Name<span class="mandatory">*</span></label>
                     <div class="col-lg-8">
                      <input type="text" class="form-control isRequired" id="projectTitle" name="projectTitle" value="<?php echo isset($data['projectTitle'])?$data['projectTitle']:""; ?>" placeholder="Enter project Title" title="Please enter project Title" />
                     </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                       <label for="categorySlug" class="col-sm-3 control-label">project Slug <span class="mandatory">*</span></label>
                       <div class="col-sm-9">
                         <input type="text" class="form-control isRequired" id="titleSlug" name="titleSlug" value="<?php echo isset($data['titleSlug'])?$data['titleSlug']:""; ?>" placeholder="project slug" title="Please enter project Slug" />
                       </div>
                    </div>
                   </div>
                  </div>
                                ...
                                <div class="col-lg-8">
                                     ...
                                     <div class="fileinput fileinput-new fileinputCat" data-provides="fileinput">
                                       ...
                                       <div><span>Image Width : <code>748px</code> Height : <code> 380px</code></span></div>
                                        <div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">											<?php $projectImg="projectImg";?>
                                           <?php if (isset($data['image']) && $data['image'] != '') { ?>
                                                <img src="../<?php echo $projectImg."/".$data['image']; ?>"/>
                                            <?php } else { ?>
