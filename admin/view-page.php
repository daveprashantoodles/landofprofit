...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Page List
			<a href="add-page.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Page</a>
		</h1>
	</section>
				...
				<div class="box">
					<div class="box-body">
						...
						<table id="employee-role-table" class="table table-bordered table-striped">
							...
							<tbody>
							<?php
								$fetch_blog=mysqli_query($con,"SELECT * FROM `page` ORDER BY `id` DESC") or die(mysqli_error($con));
								$i=1;
							...
							?>
									<tr>
										...
										<td><?php echo $i;?></td>
										<td>
											<a href="edit-page.php?id=<?php echo base64_encode($data['id']); ?>">
												<?php echo $data['title'];?>
											</a>
											
										</td>
										<td>
											<?php echo $data['titleTag'];?>
										</td>
										<td>
											<?php echo $data['slug'];?>
										</td>
...
$(".statusButton").click(function() {
	...
	if(confirm("Do you really want to change the status of this record?")) {
		window.location = "page-process.php?action=status&id="+dataid;
	}
});
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		window.location = "page-process.php?action=delete&id="+dataid;
	}
});
