...
$(document).ready(function() {
	$("#projectform").validate({
		...
		titleSlug: {
				required: true,
				// remote: "checkDuplicateprojectTitle.php",
			},
		},
    ...
    <div class="">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Add project</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="projectform" id="projectform"  method="post" action="project-process.php" autocomplete="off" enctype="multipart/form-data">
				  ...
				  <div class="row">				  <div class="col-md-6">
                    <div class="form-group">
                     <label for="name" class="col-lg-4 control-label">project Title<span class="mandatory">*</span></label>
                     <div class="col-lg-8">
                      <input type="text" class="form-control isRequired" id="projectTitle" name="projectTitle" placeholder="Enter project Title" title="Please enter project Title" />
                     </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                       ...
                       <div class="col-sm-9">
                         <input type="text" class="form-control isRequired" id="titleSlug" name="titleSlug" placeholder="project slug" title="Please enter project Slug" />
                       </div>
                    </div>
                   </div>
                  </div>
