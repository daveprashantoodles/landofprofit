...
if(isset($_POST['submit'])&&$_POST['submit']=="submit"){
	...
	$SQL = "Update wealthmgmt set `title`='".$title."',`titleTag`='".$titleTag."',`description`='".$desc."',`imgAlt`='".$imgAlt."',`imgTitle`='".$imgTitle."',`metaKeyword`='".$metaKeyword."',`metaDescription`='".$metaDescription."' where `id`=1";
	...
	if($Update){
		...
		if(isset($NameFile) && !empty($NameFile)) {
			...
			if($extension != "jpg" && $extension != "jpeg" && $extension !="png" && $extension !="gif") {
				...
				echo 'window.location.href = "wealthandmgmt.php";';
			...
			$fpath=".." . DIRECTORY_SEPARATOR . $wealthImg . DIRECTORY_SEPARATOR . $fileName;
			if(!file_exists(".." . DIRECTORY_SEPARATOR . $wealthImg) && !is_dir(".." . DIRECTORY_SEPARATOR . $wealthImg)) {
				mkdir(".." . DIRECTORY_SEPARATOR . $wealthImg);
			}
			if(move_uploaded_file($_FILES["image"]["tmp_name"], $fpath)) {
				$id =1;
				$img_stmt = $con->prepare('UPDATE `wealthmgmt` SET `image` = ? WHERE `id` = ? ');
...
$SQL = "select * from wealthmgmt where id='1'";
...
<aside class="right-side">
	...
	<section class="content-header">
		...
		<h1>Wealth Management <!--<small>Preview</small>--></h1>
									   ...
									   -->
                                        ...
                                        <div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                           ...
                                           <?php if (isset($data['image']) && $data['image'] != '') { ?>
                                                ...
                                                <img src="../<?php echo $wealthImg."/".$data['image']; ?>"/>
