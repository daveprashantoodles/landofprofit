...
$query = mysqli_query($con, "SELECT * FROM `ifd_center_latest` WHERE `center_latest_id`='".$id."' ");
    ...
    <div class="">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Detail</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                 ...
                 <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                     <label for="name" class="col-lg-4 control-label">Event Title<span class="mandatory">*</span></label>
                     <div class="col-lg-8">
                      <input type="text" class="form-control isRequired" id="newsTitle" name="newsTitle" value="<?php echo $data['title']; ?>" placeholder="Enter Title" title="Please enter Title" />
                     </div>
                    </div>
                  </div>
                  </div>
                                       ...
                                       <!--<div><span>Image Width : <code>728px</code> Height : <code> 378px</code></span></div>-->
                                        <div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                           <?php if (isset($data['image']) && $data['image'] != '') { ?>
                                                <img src="../<?php echo $clatestImg."/".$data['image']; ?>"/>
                                            <?php } else { ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-lg-9">
                      <p> <strong>Please note </strong>: Do not copy and paste content from Microsoft Word or Google Docs, the formatting might come out badly. Paste content in a notepad and then paste here and then do formatting in the editor below</p>	
                            <textarea class="form-control" id="mainDescription" name="mainDescription" rows="3" title="Please enter description"><?php echo $data['description']; ?></textarea>
                     </div>
                    </div>
                  </div>
                 </div>
