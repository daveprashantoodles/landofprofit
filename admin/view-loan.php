...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Loan List
			<a href="add-loan.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Loan</a>
		</h1>
	</section>
				...
				<div class="box">
					<div class="box-body">
						...
						<table id="employee-role-table" class="table table-bordered table-striped">
							...
							<tbody>
							<?php
								$fetch_blog=mysqli_query($con,"SELECT * FROM `loan` ORDER BY `id` DESC") or die(mysqli_error($con));
								$i=1;
							...
							?>
									<tr>
										...
										<td><?php echo $i;?></td>
										<td>
											<a href="edit-loan.php?id=<?php echo base64_encode($data['id']); ?>">
												<?php echo $data['loan_title'];?>
											</a>
											
										</td>
										<td>
										<?php
											$imgfileSource = ".." . DIRECTORY_SEPARATOR . $loanImg . DIRECTORY_SEPARATOR . $data['image'];
										...
										<td>
											<a href="view-loan-question.php?parentId=<?php echo base64_encode($data['id']); ?>">
												View Questions
											</a>
										</td>
										<td>
...
$(".statusButton").click(function() {
	...
	if(confirm("Do you really want to change the status of this record?")) {
		window.location = "loan-process.php?action=status&id="+dataid;
	}
});
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		window.location = "loan-process.php?action=delete&id="+dataid;
	}
});
