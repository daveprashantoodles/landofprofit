...
$sql = "select b.*,u.fname,u.lname,u.email,u.phone,p.house_number_name,p.street,p.town_city,p.county,p.postcode from bookings b left join users u ON u.id = b.user_id LEFT JOIN property p ON p.id = b.property_id where b.property_id = ".$property_id." order by b.id desc";
