...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Service List
			<a href="add-service.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Service</a>
		</h1>
	</section>
				...
				<div class="box">
					<div class="box-body">
						...
						<table id="employee-role-table" class="table table-bordered table-striped">
							...
							<tbody>
							<?php
								$fetch_blog=mysqli_query($con,"SELECT * FROM `services` ORDER BY `orders` asc") or die(mysqli_error($con));
								$i=1;
							...
							?>
									<tr>
										...
										<td><?php echo $i;?></td>
										<td>
											<a href="edit-service.php?id=<?php echo base64_encode($data['id']); ?>">
										...
										<!--
										<td>
											<a href="view-service-question.php?parentId=<?php //echo base64_encode($data['id']); ?>">
												View Questions
											</a>
										</td>
										-->
...
$(".statusButton").click(function() {
	...
	if(confirm("Do you really want to change the status of this record?")) {
		window.location = "service-process.php?action=status&id="+dataid;
	}
});
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		window.location = "service-process.php?action=delete&id="+dataid;
	}
});
