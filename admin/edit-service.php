            ...
            <div class="box-body">
                <form role="form" class="form-horizontal" name="serviceform" id="serviceform"  method="post" action="service-process.php" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="categorySlug" class="col-sm-3 control-label">
									Service Slug <span class="mandatory">*</span>
								</label>
								<div class="col-sm-9">
									<input type="text" class="form-control isRequired" id="titleSlug" name="titleSlug" placeholder="Service slug" title="Please enter Service Slug" value="<?php echo isset($data['titleSlug'])?$data['titleSlug']:"";?>"/>
								</div>
							</div>
						</div>
					</div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <div class="col-lg-8">
                      <input type="number" class="form-control isRequired" id="orders" name="orders"  value="<?php echo $data['orders']; ?>" />
                     </div>
                    </div>
                  </div>
                 <div class="col-md-6">
                  ...
                  <div class="col-sm-offset-2 col-sm-10">
                    <div class="checkbox">
                      <label>
                        <input name="isLendingPage" id="isLendingPage" type="checkbox" <?php echo ($data['isLendingPage']==1)?"checked":"";?>>Home Page?
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                     ...
                     <div class="col-lg-9">
                      <p> <strong>Please note </strong>: Do not copy and paste content from Microsoft Word or Google Docs, the formatting might come out badly. Paste content in a notepad and then paste here and then do formatting in the editor below</p>	
                            <textarea class="form-control" id="sort_desc" name="sort_desc" rows="3" title="Please enter description"><?php echo $data['sort_desc']; ?></textarea>
                     </div>
                    </div>
                  </div>
                 </div>
