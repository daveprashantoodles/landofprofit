    ...
    <div class="">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Add Construction Service</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
							...
							<div class="form-group"> 
								...
								<div class="col-lg-8">
									<div class="fileinput fileinput-new fileinputCat" data-provides="fileinput">
										...
										<div>
											<span>Image Width : <code>770px</code> Height : <code> 630px</code></span>
										</div>
