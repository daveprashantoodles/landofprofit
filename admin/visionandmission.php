...
if(isset($_POST['submit'])&&$_POST['submit']=="submit"){
	...
	$SQL = "Update visionandmission set `titleTag`='".$titleTag."',`description`='".$desc."',`imgAlt`='".$imgAlt."',`imgTitle`='".$imgTitle."',`metaKeyword`='".$metaKeyword."',`metaDescription`='".$metaDescription."' where `id`=1";
	...
	if($Update){
		...
		if(isset($NameFile) && !empty($NameFile)) {
			...
			if($extension != "jpg" && $extension != "jpeg" && $extension !="png" && $extension !="gif") {
				...
				echo 'window.location.href = "visionandmission.php";';
			...
			$fpath=".." . DIRECTORY_SEPARATOR . $visionImg . DIRECTORY_SEPARATOR . $fileName;
			if(!file_exists(".." . DIRECTORY_SEPARATOR . $visionImg) && !is_dir(".." . DIRECTORY_SEPARATOR . $visionImg)) {
				mkdir(".." . DIRECTORY_SEPARATOR . $visionImg);
			}
			if(move_uploaded_file($_FILES["image"]["tmp_name"], $fpath)) {
				$id =1;
				$img_stmt = $con->prepare('UPDATE `visionandmission` SET `image` = ? WHERE `id` = ? ');
...
$SQL = "select * from visionandmission where id='1'";
...
<aside class="right-side">
	...
	<section class="content-header">
		...
		<h1>Vision And Mission <!--<small>Preview</small>--></h1>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="fileinput fileinput-new fileinputCat" data-provides="fileinput">
                                     ...
                                     <!--  <div><span>Maximum Image Upload Size is <code>1MB</code></span></div>
									   ...
									   -->
                                       <div><span>Image Width : <code>570px</code> Height : <code> 465px</code></span></div>
                                        ...
                                        <div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                           ...
                                           <?php if (isset($data['image']) && $data['image'] != '') { ?>
                                                ...
                                                <img src="../<?php echo $visionImg."/".$data['image']; ?>"/>
