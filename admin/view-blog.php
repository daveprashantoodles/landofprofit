...
<div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <h1>Blog List
        ...
        <a href="add-blog.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Blog</a>
	            	...
	            	<?php if(isset($_SESSION['msg']) && $_SESSION['msg']=='delete_data') { ?>
					  ...
					  <table id="employee-role-table" class="table table-bordered table-striped">
						...
						<?php
							...
							$fetch_blog=mysqli_query($con,"SELECT * FROM `blog`") or die(mysqli_error($con));
						...
						?>
						  ...
						  <tr>
							...
							<td><a href="edit-blog.php?id=<?php echo base64_encode($data['id']); ?>"><?php echo $data['blogTitle'];?></a></td>
							
						<!--	<td><?php //echo $data['categoryTitle'];?></td>-->

							<td><?php echo date('d-m-Y',strtotime($data['blogDate']));?></td>

							<td>
								<?php 
									
									$imgfileSource = ".." . DIRECTORY_SEPARATOR . $blogImg . DIRECTORY_SEPARATOR . $data['image'];
							...
							<td><?php echo $data['blogAuthor'];?></td>
