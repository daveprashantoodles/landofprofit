...
<aside class="right-side">
	<section class="content-header">
		<h1>Add Work Image<!--<small>Preview</small>--></h1>
	</section>
			...
			<div class="col-sm-12">
				<div class="box box-info">
	                <div class="box-header with-border">
	                  <h3 class="box-title">Add Work Image</h3>
	                </div><!-- /.box-header -->
	                ...
	                <!-- form start -->
	                <form class="form-horizontal" name="albumform" id="albumform" enctype="multipart/form-data"  method="post" action="work-process.php" autocomplete="off">
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<table id="employee-role-table" class="table table-bordered table-striped">
							...
							<tbody>
							<?php
								$fetch_blog=mysqli_query($con,"SELECT * FROM `c_work` ORDER BY `album_id` ASC")or die(mysqli_error($con));
								$i=1;
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		window.location = "work-process.php?action=delete&id="+dataid;
	}
});
$(function () {
