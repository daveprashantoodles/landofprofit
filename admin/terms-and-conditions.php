...
if(isset($_POST['submit'])&&$_POST['submit']=="submit"){
	...
	$SQL = "Update terms_conditions set `title`='".$title."', `titleTag`='".$titleTag."',`description`='".$desc."',`metaKeyword`='".$metaKeyword."',`metaDescription`='".$metaDescription."' where `id`=1";
...
<aside class="right-side">
	<section class="content-header">
		<h1>Terms & Conditions <!--<small>Preview</small>--></h1>
	</section>
	<!-- Main content -->
