...
$query = mysqli_query($con, "SELECT * FROM `construction_services` WHERE `id`='".$id."' ");
...
<aside class="right-side">
	<section class="content-header">
		<h1>Construction Service<!--<small>Preview</small>--></h1>
	</section>
<!-- Main content -->
	<section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header">
                <h3 class="box-title">Edit Construction Service</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div>
			<!-- /.box-header -->
			
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="serviceform" id="serviceform"  method="post" action="service-construction-process.php" autocomplete="off" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="name" class="col-lg-4 control-label">
									Service Title<span class="mandatory">*</span>
								</label>
								<div class="col-lg-8">
									<input type="text" class="form-control isRequired" id="service_title" name="service_title" placeholder="Enter Service Title" title="Please enter Service Title" value="<?php echo isset($data['service_title'])?$data['service_title']:"";?>" />
								</div>
							</div>
						</div>
					</div>
								...
								<div class="col-lg-8">
									<div class="fileinput fileinput-new fileinputCat" data-provides="fileinput">
										...
										<div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">		
											...
											?>
												<img src="../<?php echo $serviceImg."/".$data['image']; ?>"/>
											<?php 
												}
												else{
											?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<p> <strong>Please note </strong>: Do not copy and paste content from Microsoft Word or Google Docs, the formatting might come out badly. Paste content in a notepad and then paste here and then do formatting in the editor below<strong>(Max. 320 character)</strong></p>	
