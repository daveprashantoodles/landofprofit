...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Location List
			<a href="add-location.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Location</a>
		</h1>
	</section>
				...
				<div class="box">
					<div class="box-body">
						...
						<table id="employee-role-table" class="table table-bordered table-striped">
							...
							<tbody>
							<?php
								$fetch_blog=mysqli_query($con,"SELECT * FROM `location` ORDER BY `id` DESC") or die(mysqli_error($con));
								$i=1;
							...
							?>
									<tr>
										...
										<td><?php echo $i;?></td>
										<td>
											<a href="edit-location.php?id=<?php echo base64_encode($data['id']); ?>">
												<?php echo $data['location_title'];?>
											</a>
											
										</td>
										<td>
										<?php
											$imgfileSource = ".." . DIRECTORY_SEPARATOR . $locationImg . DIRECTORY_SEPARATOR . $data['image'];
										...
										<td>
											<a href="view-location-question.php?parentId=<?php echo base64_encode($data['id']); ?>">
												View Questions
											</a>
										</td>
										<td>
...
$(".statusButton").click(function() {
	...
	if(confirm("Do you really want to change the status of this record?")) {
		window.location = "location-process.php?action=status&id="+dataid;
	}
});
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		window.location = "location-process.php?action=delete&id="+dataid;
	}
});
