...
<div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <h1>Service List
        ...
        <a href="add-offer.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Service</a>
	            	...
	            	<?php if(isset($_SESSION['msg']) && $_SESSION['msg']=='delete_data') { ?>
					  ...
					  <table id="employee-role-table" class="table table-bordered table-striped">
						...
						<?php
							...
							$fetch_blog=mysqli_query($con,"SELECT offer.* FROM `offer`  ORDER BY offer.id DESC") or die(mysqli_error($con));
						...
						?>
						  ...
						  <tr>
							...
							<td><a href="edit-offer.php?id=<?php echo base64_encode($data['id']); ?>"><?php echo $data['offerTitle'];?></a></td>
							<td>
								<?php 
									
									$imgfileSource = ".." . DIRECTORY_SEPARATOR . $offerImg . DIRECTORY_SEPARATOR . $data['image'];
...
$(".statusButton").click(function() {
	...
	if(confirm("Do you really want to change the status of this record?")) {
		...
		window.location = "offer-process.php?action=status&id="+dataid;
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		...
		window.location = "offer-process.php?action=delete&id="+dataid;
