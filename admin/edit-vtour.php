...
$query = mysqli_query($con, "SELECT * FROM `vtour` WHERE `id`='".$id."' ");
    ...
    <div class="">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Vtour</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="blogform" id="blogform"  method="post" action="vtour-process.php" autocomplete="off" enctype="multipart/form-data">
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <div class="col-lg-8">
                      <input type="text" class="form-control isRequired" id="vtourTitle" name="vtourTitle" placeholder="Enter vtour Title" title="Please enter vtour Title #1" value="<?php echo isset($data['vtourTitle'])?$data['vtourTitle']:""; ?>"/>
                     </div>
                    </div>
                  </div>
				  <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <div class="col-lg-9">
                      <input type="text" class="form-control isRequired" id="vtourTitle2" name="vtourTitle2" placeholder="Enter vtour Title" title="Please enter vtour Title #2" value="<?php echo isset($data['vtourTitle2'])?$data['vtourTitle2']:""; ?>"/>
                     </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                       ...
                       <div class="col-sm-8">
                         <input type="url" class="form-control isRequired" id="vtLink" name="vtLink" placeholder="vtLink " title="Please enter vtour link" value="<?php echo isset($data['vtLink'])?$data['vtLink']:""; ?>"/>
                       </div>
                    </div>
                   </div>
                  <div class="col-md-6">
                    <div class="form-group">
                       <label for="categorySlug" class="col-sm-3 control-label">Vtour Slug <span class="mandatory">*</span></label>
                       <div class="col-sm-9">
                                       ...
                                       <div><span>Image Width : <code>748px</code> Height : <code> 380px</code></span></div>
                                        <div id="dvPreview" class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">											
                                           <?php if (isset($data['image']) && $data['image'] != '') { ?>
                                                <img src="../<?php echo $vtourImg."/".$data['image']; ?>"/>
                                            <?php } else { ?>
