...
<div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <h1>Vtour List
        ...
        <a href="add-vtour.php" class="btn btn-primary pull-right" style="margin-top:-5px;"><i class="fa fa-plus"></i>&nbsp;Add Vtour</a>
	            	...
	            	<?php if(isset($_SESSION['msg']) && $_SESSION['msg']=='delete_data') { ?>
					  ...
					  <table id="employee-role-table" class="table table-bordered table-striped">
						...
						<?php
							...
							$fetch_blog=mysqli_query($con,"SELECT vtour.* FROM `vtour`  ORDER BY vtour.id DESC") or die(mysqli_error($con));
						...
						?>
						  ...
						  <tr>
							...
							<td><a href="edit-vtour.php?id=<?php echo base64_encode($data['id']); ?>"><?php echo $data['vtourTitle'];?></a></td>
							
							<td><?php echo $data['vtourTitle2'];?></td>
							<td>
								<?php 
									
									$imgfileSource = ".." . DIRECTORY_SEPARATOR . $vtourImg . DIRECTORY_SEPARATOR . $data['image'];
...
$(".statusButton").click(function() {
	...
	if(confirm("Do you really want to change the status of this record?")) {
		...
		window.location = "vtour-process.php?action=status&id="+dataid;
...
$(".deleteButton").click(function() {
	...
	if(confirm("Do you really want to delete this record?")) {
		...
		window.location = "vtour-process.php?action=delete&id="+dataid;
