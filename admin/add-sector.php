	...
	<section class="content">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title">Add Sector</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
			</div><!-- /.box-header -->
			<!-- form start -->
			<div class="box-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control isRequired" id="sector_title" name="sector_title" placeholder="Enter Sector Title" title="Please enter Sector Title" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control isRequired" id="titleSlug" name="titleSlug" placeholder="Sector slug" title="Please enter Sector Slug" />
								</div>
							</div>
						</div>
					</div>
