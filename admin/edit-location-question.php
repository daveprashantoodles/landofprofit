...
$query = mysqli_query($con, "SELECT * FROM `locationQuestions` WHERE `id`='".$id."' ");
...
<aside class="right-side">
	<section class="content-header">
		<h1>Location Question<!--<small>Preview</small>--></h1>
	</section>
<!-- Main content -->
	<section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Location Question</h3><div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span> indicates required field &nbsp;</div> 
            </div><!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
                <form role="form" class="form-horizontal" name="mainform" id="mainform"  method="post" action="location-question-process.php" autocomplete="off" enctype="multipart/form-data">
                 
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="name" class="col-lg-2 control-label">Location Question<span class="mandatory">*</span></label>
								<div class="col-lg-10">
