...
$(document).ready(function() {
	$("#offerform").validate({
		...
		titleSlug: {
				required: true,
				// remote: "checkDuplicateofferTitle.php",
			},
		},
                ...
                <form role="form" class="form-horizontal" name="offerform" id="offerform"  method="post" action="offer-process.php" autocomplete="off" enctype="multipart/form-data">
				  ...
				  <div class="row">				  <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <div class="col-lg-8">
                      <input type="text" class="form-control isRequired" id="offerTitle" name="offerTitle" placeholder="Enter Service Title" title="Please enter Service Title" />
                     </div>
                    </div>
                  </div>
                  <div class="col-md-6">
